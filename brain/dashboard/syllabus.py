    ...
    events = [
        {
            ...
            "time": row[7] if len(row) > 7 else None,
            "end_time": row[8] if len(row) > 8 else None,
            "weight": row[9] if len(row) > 9 else None,
            "raw_text": row[10] if len(row) > 10 else None,
            ...
            "location": row[15] if len(row) > 15 else None,
            "attendees": row[16] if len(row) > 16 else None,
            "visibility": row[17] if len(row) > 17 else None,
            "transparency": row[18] if len(row) > 18 else None,
            "reminders": row[19] if len(row) > 19 else None,
            "time_zone": row[20] if len(row) > 20 else None,
            "google_event_id": row[21] if len(row) > 21 else None,
            "google_calendar_id": row[22] if len(row) > 22 else None,
            "google_calendar_name": row[23] if len(row) > 23 else None,
            "google_updated_at": row[24] if len(row) > 24 else None,
            "updated_at": row[25] if len(row) > 25 else None,
        }

...
"""
        ...
        for chunk_index, chunk_content in enumerate(content_windows, start=1):
            user_prompt = (
                ...
                "- Prefer explicit learning-objective bullet lists from the source.\n"
                "- Then prefer existing stored objectives when still supported.\n"
                "- Only synthesize new objectives when no explicit or stored objective covers the chunk.\n\n"
                "Global output rules:\n"
...
"""
            consolidation_prompt = (
                ...
                "- Prefer explicit learning-objective bullet lists from the source.\n"
                "- Then prefer existing stored objectives when still supported.\n"
                "- Only synthesize new objectives when no explicit or stored objective covers the full material.\n\n"

import{c as I,r as d,j as e,b as k,v as W}from"./index-3kPenzRE.js";import{b as j,B as O,h as T,u as A,L as U,j as z,i as M}from"./index-FGW8D4iK.js";import{C as v,a as L,b as P,c as K}from"./card-B2HT9J6Y.js";import{T as $,a as q,b as F,c as _}from"./tabs-CJ2n6bmG.js";import{L as R}from"./loader-circle-BwdFfNSc.js";import{b as w,a as D,M as V,r as X,F as Y}from"./index-DgwPTlc_.js";import{L as J}from"./link-Dy-CtZ2N.js";/**
 * @license lucide-react v0.545.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Q=[["path",{d:"m16 18 6-6-6-6",key:"eg8j8"}],["path",{d:"m8 6-6 6 6 6",key:"ppft3o"}]],E=I("code",Q);/**
 * @license lucide-react v0.545.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Z=[["rect",{width:"14",height:"14",x:"8",y:"8",rx:"2",ry:"2",key:"17jyea"}],["path",{d:"M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2",key:"zix9uf"}]],ee=I("copy",Z);/**
 * @license lucide-react v0.545.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const se=[["path",{d:"M11.017 2.814a1 1 0 0 1 1.966 0l1.051 5.558a2 2 0 0 0 1.594 1.594l5.558 1.051a1 1 0 0 1 0 1.966l-5.558 1.051a2 2 0 0 0-1.594 1.594l-1.051 5.558a1 1 0 0 1-1.966 0l-1.051-5.558a2 2 0 0 0-1.594-1.594l-5.558-1.051a1 1 0 0 1 0-1.966l5.558-1.051a2 2 0 0 0 1.594-1.594z",key:"1s2grr"}],["path",{d:"M20 2v4",key:"1rf3ol"}],["path",{d:"M22 4h-4",key:"gwowj6"}],["circle",{cx:"4",cy:"20",r:"2",key:"6kqj1y"}]],te=I("sparkles",se);function ae(n){return n.toLowerCase().trim().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").slice(0,80)}function re(n){const s=(n||"").split(`
...
╚══════════════════════════════════════════════════════════════════════════════╝
        ...
        └─────────────────────────────────────────┘`;function be(){const n=W(),[s,o]=d.useState(null),[r,x]=d.useState(null),[m,i]=d.useState("content");d.useEffect(()=>{const u=new URLSearchParams(n).get("path");u&&o(u)},[n]);const{data:c,isLoading:g,error:l}=A({queryKey:["sop-index"],queryFn:()=>M.sop.getIndex()}),{data:p,isLoading:h,error:S}=A({queryKey:["sop-file",s],queryFn:()=>s?s==="concept-map"?{content:de}:M.sop.getFile(s):null,enabled:!!s}),t=d.useCallback(a=>{o(a),i("content");const u=`/tutor?path=${encodeURIComponent(a)}`;window.history.pushState({},"",u)},[]);d.useEffect(()=>{if(p?.content&&window.location.hash){const a=decodeURIComponent(window.location.hash.slice(1));setTimeout(()=>{const u=document.getElementById(a);u&&u.scrollIntoView({behavior:"smooth"})},100)}},[p?.content]);const b=d.useCallback(()=>{p?.content&&(navigator.clipboard.writeText(p.content),x("content"),setTimeout(()=>x(null),2e3))},[p?.content]),f=d.useCallback(()=>{if(s){const a=`${window.location.origin}/tutor?path=${encodeURIComponent(s)}`;navigator.clipboard.writeText(a),x("link"),setTimeout(()=>x(null),2e3)}},[s]),y=d.useCallback(()=>{if(s){const a=JSON.stringify({path:s,anchor:"",label:s.split("/").pop()?.replace(".md","")||s},null,2);navigator.clipboard.writeText(a),x("sopref"),setTimeout(()=>x(null),2e3)}},[s]),G=c?.default_group||"runtime",B=d.useMemo(()=>{if(!c||!s)return null;for(const a of c.groups)for(const u of a.sections){const N=u.items.find(H=>H.path===s);if(N)return N.title}return s.split("/").pop()},[c,s]);return e.jsx(U,{children:e.jsxs("div",{className:"min-h-[calc(100vh-140px)] flex flex-col md:flex-row gap-4",children:[e.jsx("aside",{className:"w-full md:w-80 shrink-0",children:e.jsxs(v,{className:"min-h-[calc(100vh-140px)] bg-black/40 border-2 border-primary rounded-none flex flex-col",children:[e.jsx(L,{className:"border-b border-secondary p-3 sticky top-0 bg-black/95 z-10",children:e.jsxs(P,{className:"font-arcade text-sm flex items-center gap-2",children:[e.jsx(w,{className:"w-4 h-4"})," SOP EXPLORER"]})}),e.jsx("div",{className:"flex-1",children:e.jsxs("div",{className:"p-2 space-y-2",children:[e.jsxs("button",{onClick:()=>t("concept-map"),className:k("w-full text-left p-2 text-sm font-arcade uppercase bg-secondary/20 hover:bg-secondary/30 flex items-center gap-2 transition-colors border-l-2 mb-2",s==="concept-map"?"bg-primary/30 border-primary text-primary":"border-primary/50"),children:[e.jsx(E,{className:"w-4 h-4"}),"CONCEPT MAP"]}),g?e.jsx("div",{className:"flex items-center justify-center py-8",children:e.jsx(R,{className:"w-6 h-6 animate-spin text-primary"})}):l?e.jsx("div",{className:"text-red-500 text-sm p-4 font-terminal",children:"Failed to load SOP index"}):c?c.groups.map(a=>e.jsx(le,{group:a,selectedPath:s,onSelect:t,defaultOpen:a.id===G},a.id)):null]})})]})}),e.jsxs(v,{className:"flex-1 bg-black/60 border-2 border-primary rounded-none flex flex-col",children:[e.jsxs("div",{className:"border-b border-secondary p-3 flex items-center justify-between gap-2 bg-black/40 sticky top-0 z-10",children:[e.jsx("div",{className:"font-arcade text-xs text-primary truncate",children:s?e.jsxs("span",{className:"flex items-center gap-2",children:[s==="concept-map"?e.jsx(E,{className:"w-4 h-4"}):e.jsx(D,{className:"w-4 h-4"}),s==="concept-map"?"PT STUDY SOP — CONCEPT MAP":B||s]}):e.jsx("span",{className:"text-muted-foreground",children:"SELECT A FILE TO VIEW"})}),s&&e.jsxs("div",{className:"flex gap-2 shrink-0",children:[e.jsx(C,{onClick:b,icon:ee,label:"CONTENT",copied:r==="content"}),e.jsx(C,{onClick:f,icon:J,label:"LINK",copied:r==="link"}),e.jsx(C,{onClick:y,icon:E,label:"SOPREF",copied:r==="sopref"})]})]}),e.jsxs($,{value:m,onValueChange:a=>i(a),className:"flex-1 flex flex-col",children:[e.jsxs(q,{className:"bg-black/60 border-b border-secondary rounded-none p-1 w-full justify-start sticky top-0 z-10",children:[e.jsx(F,{value:"content",className:"rounded-none font-arcade text-[10px] data-[state=active]:bg-primary data-[state=active]:text-black px-3",children:"CONTENT"}),e.jsx(F,{value:"breakdown",className:"rounded-none font-arcade text-[10px] data-[state=active]:bg-primary data-[state=active]:text-black px-3",disabled:!p?.content||s==="concept-map",children:"BREAKDOWN"})]}),e.jsx(_,{value:"content",className:"flex-1 mt-0",children:e.jsx("div",{className:"h-full",children:e.jsx("div",{className:"p-6",children:s?h?e.jsx("div",{className:"flex items-center justify-center py-12",children:e.jsx(R,{className:"w-8 h-8 animate-spin text-primary"})}):S?e.jsxs("div",{className:"text-red-500 font-terminal",children:["Failed to load file: ",s]}):p?.content?s==="concept-map"?e.jsx("div",{className:"p-6 overflow-auto h-full",children:e.jsx("pre",{className:"font-mono text-xs leading-relaxed text-primary whitespace-pre-wrap break-words bg-black/30 p-4 border border-secondary rounded",children:p.content})}):e.jsx("article",{className:`prose prose-invert prose-primary max-w-none font-terminal text-sm leading-relaxed\r

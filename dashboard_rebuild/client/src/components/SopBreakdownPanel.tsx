...
export function SopBreakdownPanel({
  ...
  return (
    <div className="grid lg:grid-cols-3 gap-4">
      <Card className="bg-black/40 border-[3px] border-double border-primary rounded-none lg:col-span-1 flex flex-col">
      ...
      <Card className="bg-black/60 border-[3px] border-double border-primary rounded-none lg:col-span-2 flex flex-col">
        <CardHeader className="border-b border-secondary sticky top-0 bg-black/95 z-10">

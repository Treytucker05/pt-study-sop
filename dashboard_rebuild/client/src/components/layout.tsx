...
import { BookOpen, Save, Trash2, GripVertical, Pencil, X, Check, Menu, Palette } from "lucide-react";
    ...
    >
      ...
      <a
        ...
        className={cn(
          ...
          "pointer-events-auto fixed right-3 z-[60] min-h-0 gap-1.5 border-primary/45 bg-black/55 px-2.5 py-1.5 text-[0.62rem] uppercase tracking-[0.14em] shadow-[0_8px_24px_rgba(0,0,0,0.45)] backdrop-blur-sm max-lg:top-[4.75rem] lg:top-4 lg:px-3 lg:text-xs",
        )}

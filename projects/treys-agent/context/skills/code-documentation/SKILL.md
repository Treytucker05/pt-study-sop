...
## Docs sync workflow
Use when the user asks to update docs so they match code changes, or to prep docs for a release/PR.

### Inputs (ask if missing)
- What changed and who the docs are for.
- Which doc surfaces matter (README, docs site, runbooks, API spec, changelog).
- Any required tone or format.

### Workflow
1) Identify changes (use diff or change list).
2) Inventory doc surfaces:
   - README.md, docs/, CONTRIBUTING.md, CHANGELOG.md
   - openapi.*, schema.graphql, adr/, runbooks/
3) Decide what needs updates:
...
5) Verify docs are consistent (run doc checks if present).

### Deliverable
- List of docs files updated and why.
- How to verify (commands or manual checks).

### References (moved from docs-sync)
- `references/docs-structure.md`
- `references/adr-template.md`
- `references/doc-update-checklist.md`
- `references/doc-snippets.md`

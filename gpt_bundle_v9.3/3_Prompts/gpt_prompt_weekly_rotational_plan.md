# GPT Prompt: Weekly Rotational Plan (v9.3)

You are building a weekly plan using the 3+2 rotation and adaptive spacing.
...
Reference schema: `sop/logging_schema_v9.3.md`.

...
## Using PT Study SOP v8.1.1

For day-to-day studying or Custom GPT setup, follow these steps:

1. Extract/upload the 9 v8.1.1 files listed in `USAGE.md` (`Runtime_Prompt.md`, `Master_Index.md`, Modules 1-7).
...
Welcome to the **PT Study SOP** repository. The current release is v8.1.1 (see above). The remaining sections capture the v7.2 documentation set for archival/reference purposes.

...
|---|---|---|---|---|---|---|
| `codex-implement` | `SCL2-100 / SCL3-100` ship the Studio L2 overview contract and L3 review-loop hardening track, executing the L2 wave first | `conductor/tracks/studio-l2-l3-hub-review-loop_20260315/`, `docs/root/TUTOR_TODO.md`, `docs/root/AGENT_BOARD.md`, `conductor/tracks.md`, `brain/dashboard/api_tutor_studio.py`, `brain/tests/test_tutor_studio.py`, `dashboard_rebuild/client/src/api.ts`, `dashboard_rebuild/client/src/api.types.ts`, `dashboard_rebuild/client/src/__tests__/api.test.ts`, `dashboard_rebuild/client/src/components/StudioClassDetail.tsx`, `dashboard_rebuild/client/src/components/__tests__/StudioClassDetail.test.tsx`, `dashboard_rebuild/client/src/pages/__tests__/tutor.workspace.integration.test.tsx`, `dashboard_rebuild/client/src/components/TutorStudioMode.tsx`, `dashboard_rebuild/client/src/components/__tests__/TutorStudioMode.test.tsx`, `README.md` | `in_progress` | none | `GET /api/tutor/studio/overview` shipped; Studio L2 now renders from the overview payload; targeted pytest/vitest/build PASS; live `/tutor?mode=studio` proof PASS after restarting the stale `dashboard_web.py` process on port 5000 | move into `SCL3-100`: add Studio item update/history/archive behavior and wire the L3 review loop into `TutorStudioMode.tsx` |
| `codex-implement` | `CBTU-100` unify the shell and top-level route visuals around the cyber-brain reference image | `conductor/tracks/cyber-brain-theme-unification_20260315/`, `docs/root/TUTOR_TODO.md`, `docs/root/AGENT_BOARD.md`, `conductor/tracks.md`, `dashboard_rebuild/client/src/index.css`, `dashboard_rebuild/client/src/components/layout.tsx`, `dashboard_rebuild/client/src/components/ui/button.tsx`, `dashboard_rebuild/client/src/components/ui/card.tsx`, `dashboard_rebuild/client/src/components/ui/input.tsx`, `dashboard_rebuild/client/src/components/ui/textarea.tsx`, `dashboard_rebuild/client/src/components/PageScaffold.tsx`, `dashboard_rebuild/client/src/lib/theme.ts`, `dashboard_rebuild/client/src/pages/brain.tsx`, `dashboard_rebuild/client/src/pages/scholar.tsx`, `dashboard_rebuild/client/src/pages/tutor.tsx`, `dashboard_rebuild/client/src/pages/library.tsx`, `dashboard_rebuild/client/src/pages/calendar.tsx`, `dashboard_rebuild/client/src/pages/mastery.tsx`, `dashboard_rebuild/client/src/pages/methods.tsx`, `dashboard_rebuild/client/src/pages/vault-health.tsx`, targeted layout/frontend tests` | `done` | none | holographic shell backdrop, shared `PageScaffold`, upgraded panel/button/input primitives, and top-level route header alignment shipped; `npm run test -- client/src/components/__tests__/layout.test.tsx` PASS; `cd dashboard_rebuild && npm run build` PASS | none |
| `codex-implement` | `TPCD-100` ship the responsive `DashBoard` first-page command deck and wire resume, schedule, project, and library CTAs into the shell | `conductor/tracks/tutor-page1-command-deck_20260315/`, `docs/root/TUTOR_TODO.md`, `docs/root/AGENT_BOARD.md`, `conductor/tracks.md`, `conductor/tracks/GENERAL/log.md`, `brain/dashboard/api_tutor_projects.py`, `brain/tests/test_tutor_project_shell.py`, `dashboard_rebuild/client/src/pages/tutor.tsx`, `dashboard_rebuild/client/src/components/TutorCommandDeck.tsx`, `dashboard_rebuild/client/src/components/TutorScheduleMode.tsx`, `dashboard_rebuild/client/src/components/TutorStudioMode.tsx`, `dashboard_rebuild/client/src/pages/library.tsx`, `dashboard_rebuild/client/src/lib/tutorClientState.ts`, `dashboard_rebuild/client/src/api.ts`, `dashboard_rebuild/client/src/api.types.ts`, targeted Tutor frontend/backend tests` | `done` | none | `/api/tutor/hub` shipped; `/tutor` now lands on `DashBoard`; `Tutor` is live-study only; backend pytest PASS; targeted vitest PASS; `npm run build` PASS | none |

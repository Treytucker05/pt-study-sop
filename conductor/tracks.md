...
Latest non-track update: 2026-02-22 Added North Star test-isolation guardrails to block Obsidian writes during pytest/testing contexts (see `conductor/tracks/GENERAL/log.md`).

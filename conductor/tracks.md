...
Latest non-track update: 2026-02-19 Startup hard-stop on port 5000 + deterministic selected-file listing shortcut + retrieval telemetry/ANN diagnostics + tutor noise/unload/retrieval fixes (see `conductor/tracks/GENERAL/log.md`).

...
- define the 10/10 release gate for the Tutor
- certify selectable template chains, material intake, outputs, and neuro golden paths
- convert the certification bar into machine-readable and testable repo state

## Current Progress

- certification track opened and linked into sprint/board surfaces
- scorecard, severity policy, fixture plan, and chain disposition registry authored
- template-chain API will expose certification metadata as the first runtime certification contract

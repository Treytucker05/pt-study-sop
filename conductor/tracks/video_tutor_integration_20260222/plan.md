...
- [x] Task 2.1: Add `.mp4` to accepted upload extensions in:
...
- [x] Task 4.1: Add backend tests for new video endpoints
- [ ] Task 4.2: Update frontend tests for mp4 acceptance + process action
- [x] Task 4.3: Verify with `python -m pytest brain/tests/`
- [x] Task 4.4: Verify with `cd dashboard_rebuild && npm run build`

## Notes

- API enrichment endpoint and retrieval/citation prioritization are not implemented yet.
- Frontend tests for the new process button/status polling remain open.

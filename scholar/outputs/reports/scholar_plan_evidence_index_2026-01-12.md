# Scholar Plan Evidence Index (2026-01-12)
...
- `scholar/outputs/proposals/` (approved/rejected)

## Open Questions
- `scholar/outputs/orchestrator_runs/questions_needed_*.md`
- `scholar/outputs/orchestrator_runs/questions_answered_*.md`

## Evidence Gaps
- No single automated link between plan updates and SOP edits (manual step).
